...
- [ ] T020 [P] [US1] Acceptance scenario 3 (`SACP_RESPONSE_SHAPING_ENABLED=false` → no scoring runs, no retries, draft enters verbatim) in [tests/test_021_filler_scorer.py](./../../tests/test_021_filler_scorer.py) — overlaps with the SC-002 canary (T017) but exercises the dispatch-path-level guarantee
