...
| Test `test_019_middleware_order.py` fails | Some middleware was registered before NetworkRateLimit | The FR-002 startup-test caught a regression. Inspect `src/mcp_server/app.py::_add_middleware` registration order. |
