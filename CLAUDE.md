...
## Recent Changes
- Providers (2026-04-24) — Gemini and Groq added to the sponsor `_AddAIBody` provider whitelist and the Web UI AddParticipantDialog + ResetAICredentialsDialog. Defaults: `gemini/gemini-2.0-flash` (1M ctx) and `groq/llama-3.3-70b-versatile` (128k ctx). LiteLLM handles dispatch with no provider-specific branching needed.
